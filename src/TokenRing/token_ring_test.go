...
// it's the same as the test file in package LamportDistributedMutualExclusion and RicartAgrawala.
import (
	"fmt"
	"log"
	"math/rand"
...
func init() {
	logger = CreateLog("log/token_ring_test.log", "")
}
...
func TestTokenRing1(t *testing.T) {
	phaseNum := 2
	peerCnt := 2
	msgCnt := 1
...
func TestTokenRing2(t *testing.T) {
	phaseNum := 2
	peerCnt := 2
	msgCnt := 5
...
func TestTokenRing3(t *testing.T) {
	phaseNum := 2
	peerCnt := 2
	msgCnt := 50
...
func TestTokenRing4(t *testing.T) {
	phaseNum := 2
	peerCnt := 5
	msgCnt := 2
...
func TestTokenRing5(t *testing.T) {
	phaseNum := 2
	peerCnt := 5
	msgCnt := 10
	timeout := 5000 * phaseNum
...
func TestTokenRing6(t *testing.T) {
	phaseNum := 2
	peerCnt := 5
	msgCnt := 50
	timeout := 60000 * 2
...
func TestTokenRing7(t *testing.T) {
	phaseNum := 2
	peerCnt := 10
	msgCnt := 50
...
func TestTokenRing8(t *testing.T) {
	phaseNum := 2
	peerCnt := 10
	msgCnt := 100
...
func TestTokenRing9(t *testing.T) {
	phaseNum := 2
	peerCnt := 20
	msgCnt := 100

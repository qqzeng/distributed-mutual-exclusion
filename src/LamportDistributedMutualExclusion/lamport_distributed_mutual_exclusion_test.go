...
func init() {
	logger = CreateLog("log/lamport_mutual_test.log", "")
}
...
func TestLamportMutual1(t *testing.T) {
	phaseNum := 2
	peerCnt := 2
	msgCnt := 1
...
func TestLamportMutual2(t *testing.T) {
	phaseNum := 2
	peerCnt := 2
	msgCnt := 5
...
func TestLamportMutual3(t *testing.T) {
	phaseNum := 2
	peerCnt := 2
	msgCnt := 50
...
func TestLamportMutual4(t *testing.T) {
	phaseNum := 2
	peerCnt := 5
	msgCnt := 2
...
func TestLamportMutual6(t *testing.T) {
	phaseNum := 2
	peerCnt := 5
	msgCnt := 50
	timeout := 60000 * 2
...
func TestLamportMutual7(t *testing.T) {
	phaseNum := 2
	peerCnt := 10
	msgCnt := 50
...
func TestLamportMutual8(t *testing.T) {
	phaseNum := 2
	peerCnt := 10
	msgCnt := 100
...
func TestLamportMutual9(t *testing.T) {
	phaseNum := 2
	peerCnt := 20
	msgCnt := 100
